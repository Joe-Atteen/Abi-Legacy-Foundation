  ...
  return (
    ...
    >
      <motion.div
        ...
        className="overflow-hidden rounded-[32px] flex flex-col justify-center bg-amber-50 max-h-[750px]"
      >
        <Image
          src="/image-5.webp"
          alt="discover"
      ...
      >
        ...
        <p className="text-base lg:text-lg mb-5">
          My name is Abigail Akwambea Elorm Yaa Mensah, and I am the founder of
          Legacy Foundation.
        </p>
        ...
        <p className="text-base lg:text-lg">
          ...
          thrive. I&apos;m committed to empowering girl children, widows, and orphans
