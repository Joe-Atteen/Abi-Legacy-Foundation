...
const Mission = () => {
  ...
  return (
    <div className="bg-primary mission-bg relative">
          ...
          <div className="grid md:grid-cols-2 gap-14 md:gap-20 max-w-5xl mx-auto mb-14">
            ...
            >
              ...
              <p className="text-base md:text-2xl mt-10">
                We believe every individual deserves equal access to resources
                and opportunities
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="grid grid-cols-1 gap-20 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-base md:text-2xl mt-10">
                ...
                partnerships. By focusing on education, economic empowerment,
                and social support, we envision a future where girl children,
                widows, and orphans thrive and contribute positively to their
                communities.
              </p>
            </motion.div>
          </div>
